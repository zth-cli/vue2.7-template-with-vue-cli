<template>
  <div class="from_data_main">
    <el-form :model="fromData" :rules="rules" :ref="ref" label-width="100px" :class="[
    ...
    <div class="btns" v-if="postUrl">
      <el-button type="primary" @click="submitForm(ref)">提交</el-button>
      <el-button @click="resetForm(ref)" class="warning">重置</el-button>
    </div>
  </div>
</template>
