 ...
 * @LastEditors: 阮志雄
 * @LastEditTime: 2022-08-15 16:06:54
...
const colunmsList = [
  ...
  {
    typeId: 6, // 重要线路实际停运及其影响的发用电设备
    colunms: [
      {
        prop: 'dataName',
        label: '数据名称',
        align: 'center',
        default: '重要线路实际停运及其影响的发用电设备',
      },
  ...
  {
    typeId: 7, // 市场运营机构采取的任何对市场交易产生影响的操作
    colunms: [
      {
        prop: 'dataName',
        label: '数据名称',
        align: 'center',
        default: '市场运营机构采取的任何对市场交易产生影响的操作',
      },
      { prop: 'time', label: '日期', align: 'center', propType: 'date' },
  ...
  {
    typeId: 9, // 考虑所有已知影响的年前系统间联络线输电能力预测
    colunms: [
      {
        prop: 'dataName',
        label: '数据名称',
        align: 'center',
        default: '考虑所有已知影响的年前系统间联络线输电能力预测',
      },
  ...
  {
    typeId: 10, // 考虑所有已知影响的月前系统间联络线输电能力预测
    colunms: [
      {
        prop: 'dataName',
        label: '数据名称',
        align: 'center',
        default: '考虑所有已知影响的月前系统间联络线输电能力预测',
      },
  ...
  {
    typeId: 11, // 考虑所有已知影响的周前系统间联络线输电能力预测
    colunms: [
      {
        prop: 'dataName',
        label: '数据名称',
        align: 'center',
        default: '考虑所有已知影响的周前系统间联络线输电能力预测',
      },
